module.exports = {
        ...
        <body>
            <script type="text/javascript">
                ...
                function deleteToDoList() {
                    var del_confirm = confirm("리셋 하시겠습니까?");
                    if(del_confirm) {
            ...
            <div id='container'>
                <div id='grid'>
                    <div id='menu'>
                        <div class='menu_list'><a href="/page/toDoList">Today's to do list</a></div>
            ...
            <script>
                ...
                list.addEventListener('click', function(event) {
                    ...
                    if(achieve_rate == 100) {
                        document.getElementById("graph_num").style.color = "olive";
                    } else {
                        document.getElementById("graph_num").style.color = "green";
                    }
    ...
    HOME : function(statusUI = `<div class="top-menu"></div>
    <div class='top-menu'><a href="/auth/login">Sign-in</a></div>
    <div class='top-menu'>|</div>
    <div class='top-menu'><a href="/auth/register">Sign-up</a></div>
    <div class='top-menu'></div>`) {
        return `
            ...
            <html>
                <head>
                    <meta charset="utf-8">
                    <title>My Mission Planner</title>
                    <link rel="stylesheet" href="/stylesheets/plan.css">
                    <style>
                        body {
                ...
                <body>
                    <div id='top' style="background-color: transparent">
                        <div id='access' style="font-size:larger">
                            ${statusUI}
                        </div>
                        <h1 style="font-size:4rem">My Mission Planner</h1>
                    </div>
                    <br>
                    <div id="circle" onclick="go_toDoList()">시작하기</div>
                    <script>
                    function go_toDoList() {
                        location.href = "/page/toDoList";
                    }
                    </script>
                </body>
            </html>`
    ...
    LOGIN : function(title, body) {
        ...
        <body>
            <script>
             function goTo_facebook_login() {
                location.href = "/auth/faccebook";
             }
            </script>
            <div class="login">
